...
mod data {
    ...
    use diesel::sql_types::{BigInt, Binary, Bytea, Date, Integer, Jsonb, Text};
    ...
    use graph::prelude::chrono::NaiveDate;
    ...
    impl CallMetaTable {
        ...
        pub fn accessed_at(&self) -> DynColumn<Date> {
            self.table.column::<Date, _>(Self::ACCESSED_AT)
        }
    }
            ...
            let rows = match self {
                Storage::Shared => {
                    ...
                    cache::table
                        ...
                        .get_results::<(Vec<u8>, Vec<u8>, Vec<u8>, NaiveDate)>(conn)?
                }
                Storage::Private(Schema {
                    call_cache,
                    call_meta,
